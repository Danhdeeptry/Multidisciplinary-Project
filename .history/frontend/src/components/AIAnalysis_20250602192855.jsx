...
const AIAnalysis = () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h2 style={{ color: '#2e7d32', fontWeight: 800, fontSize: 36, marginBottom: 32, textAlign: 'center', letterSpacing: 1 }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {preview ? (
            ...
            <>
              <span style={{ fontSize: '64px', color: '#2e7d32', display: 'block', textAlign: 'center' }}>📸</span>
              <p style={{ color: '#666', marginTop: '16px', fontSize: '20px', fontWeight: 600, textAlign: 'center' }}>
